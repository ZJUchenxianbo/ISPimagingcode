...
distance. Experiments 1 and 2 use 974 Lebedev incident and observation
directions at the anchor $k=15$. Experiments 3 and 4 vary the direction count
with frequency, approximately as
$k^{3/2}$ and rounded upward to a supported positive-weight Lebedev rule, so
that the scaled mock-node error $C\,\mathrm{dist}(p,p_{\rm mock})$ remains more
...
$n_{\mathrm{axis}}=23$. The three noise levels use the same standard complex
noise realization scaled to the requested relative norm. The direction sets,
quadrature nodes, polarimetric
...
data at every frequency. The relative noise level is fixed at $\delta=0.2$.
The direction count grows with frequency from the Experiment 1 anchor
$k=15$, $N_{\rm dir}=974$. The GPSWF, Full VIE, and direction parameters are listed
...
\begin{table}[htbp]
    ...
    \begin{tabular}{rrrrrrrrr}
        ...
        & $n_r$ & $n_{\mathrm{ang}}$ & $n_{\mathrm{axis}}$ & $N_{\rm dir}$\\
        \midrule
        4  & 8  & 20 & 4  & 2 & 6  & 74  & 11 & 170\\
        6  & 12 & 26 & 5  & 3 & 8  & 110 & 11 & 302\\
        8  & 16 & 32 & 7  & 3 & 10 & 146 & 13 & 434\\
        10 & 20 & 40 & 8  & 5 & 12 & 194 & 16 & 590\\
        15 & 30 & 48 & 12 & 7 & 12 & 230 & 23 & 974\\
        20 & 40 & 80 & 14 & 7 & 28 & 434 & 31 & 1730\\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{rrrrrrrrr}
        ...
        & $n_r$ & $n_{\mathrm{ang}}$ & $n_{\mathrm{axis}}$ & $N_{\rm dir}$\\
        \midrule
        8  & 16 & 28 & 7  & 3 & 8  & 86  & 13 & 434\\
        12 & 24 & 40 & 9  & 5 & 10 & 170 & 19 & 770\\
        15 & 30 & 48 & 12 & 7 & 12 & 230 & 23 & 974\\
        \bottomrule
    \end{tabular}
\end{table}
...
Experiment 1, Experiment 2, and the $k=15$ rows of Experiments 3 and 4 use
$n_{\mathrm{axis}}=23$, corresponding to 19209 complex field unknowns. The
dense matrix alone requires approximately 5.50 GiB, and LU factorization
requires additional memory. The $k=20$ row of Experiment 3 uses
$n_{\mathrm{axis}}=31$, corresponding to 46545 unknowns and approximately
32.28 GiB for the dense matrix before LU workspace. Formal runs should therefore be
