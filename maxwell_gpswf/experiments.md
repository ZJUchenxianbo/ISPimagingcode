...
| k | C | ℓ_max | n_modes_per_ℓ | K | n_radial | n_angular | 总模式数 |
|---|---|---|---|---|---|---|---|
| 10 | 20 | 8 | 5 | 36 | 8 | 110 | 405 |
| 20 | 40 | 14 | 6 | 54 | 12 | 170 | 1350 |
| 30 | 60 | 18 | 7 | 68 | 14 | 230 | 2527 |
| 40 | 80 | 22 | 8 | 86 | 16 | 302 | 4232 |
...
**截断**：双层 — GPSWF 参数（ℓ_max, n_modes）限定空间，ε=0.2 过滤尾部小 |α|。
...
**截断**：双层 — GPSWF 参数（ℓ_max=12, n_modes=7）限定空间，ε=0.1 过滤尾部小 |α|。
